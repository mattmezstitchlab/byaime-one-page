          ...
          <div className="mt-10 relative w-full group">
            ...
            <div className="relative bg-background/40 backdrop-blur-xl border border-foreground/10 rounded-3xl p-2 sm:p-3 transition-all focus-within:border-foreground/30 focus-within:bg-background/60 shadow-2xl">
              <textarea
                ...
                className="w-full bg-transparent border-none outline-none resize-none text-foreground/90 placeholder:text-foreground/30 text-lg md:text-xl p-4 min-h-[120px] font-light leading-relaxed"
              />
              ...
              <div className="flex justify-between items-end px-4 pb-2">
                <div className="flex-1 flex gap-2 overflow-hidden">
                  {draft && (
                    ...
                    >
                      {draft.universe && (
                        <span className="text-[10px] uppercase tracking-widest px-2 py-1 rounded-full bg-foreground/10 text-foreground/70 border border-foreground/5">
                          {draft.universe}
                        </span>
                      )}
                  ...
                  className="flex-shrink-0 ml-4 h-12 w-12 rounded-full bg-white text-black flex items-center justify-center disabled:opacity-30 disabled:bg-foreground/10 disabled:text-foreground transition-all hover:scale-105 active:scale-95"
                >
