  ...
  return (
    <section className="w-full py-32 md:py-48 bg-background relative overflow-hidden flex items-center justify-center">
      ...
      <motion.div 
        ...
        className="absolute left-[-10%] top-[20%] w-[30vw] h-[40vh] bg-cover bg-center grayscale rounded-3xl -rotate-6"
      ...
      <motion.div 
        ...
        className="absolute right-[-10%] bottom-[10%] w-[25vw] h-[45vh] bg-cover bg-center grayscale rounded-3xl rotate-3"
