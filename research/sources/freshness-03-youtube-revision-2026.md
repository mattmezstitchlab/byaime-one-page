...
Title: Revision History  |  YouTube Data API  |  Google for Developers
Fetched: 2026-09-08T00:43:49.833Z

[Skip to main content](https://developers.google.com/youtube/v3/revision_history#main-content)
...
- [English](https://developers.google.com/youtube/v3/revision_history)
- [Deutsch](https://developers.google.com/youtube/v3/revision_history?hl=de)
- [Español](https://developers.google.com/youtube/v3/revision_history?hl=es)
- [Español – América Latina](https://developers.google.com/youtube/v3/revision_history?hl=es-419)
- [Français](https://developers.google.com/youtube/v3/revision_history?hl=fr)
- [Indonesia](https://developers.google.com/youtube/v3/revision_history?hl=id)
- [Italiano](https://developers.google.com/youtube/v3/revision_history?hl=it)
- [Polski](https://developers.google.com/youtube/v3/revision_history?hl=pl)
- [Português – Brasil](https://developers.google.com/youtube/v3/revision_history?hl=pt-br)
- [Tiếng Việt](https://developers.google.com/youtube/v3/revision_history?hl=vi)
- [Türkçe](https://developers.google.com/youtube/v3/revision_history?hl=tr)
- [Русский](https://developers.google.com/youtube/v3/revision_history?hl=ru)
- [עברית](https://developers.google.com/youtube/v3/revision_history?hl=he)
- [العربيّة](https://developers.google.com/youtube/v3/revision_history?hl=ar)
- [فارسی](https://developers.google.com/youtube/v3/revision_history?hl=fa)
- [हिंदी](https://developers.google.com/youtube/v3/revision_history?hl=hi)
- [বাংলা](https://developers.google.com/youtube/v3/revision_history?hl=bn)
- [ภาษาไทย](https://developers.google.com/youtube/v3/revision_history?hl=th)
- [中文 – 简体](https://developers.google.com/youtube/v3/revision_history?hl=zh-cn)
- [中文 – 繁體](https://developers.google.com/youtube/v3/revision_history?hl=zh-tw)
- [日本語](https://developers.google.com/youtube/v3/revision_history?hl=ja)
- [한국어](https://developers.google.com/youtube/v3/revision_history?hl=ko)

Sign in

- On this page
- [September 1, 2026](https://developers.google.com/youtube/v3/revision_history#september-1,-2026)
- [August 27, 2026](https://developers.google.com/youtube/v3/revision_history#august-27,-2026)
- [August 6, 2026](https://developers.google.com/youtube/v3/revision_history#august-6,-2026)
- [July 7, 2026](https://developers.google.com/youtube/v3/revision_history#july-7,-2026)
- [June 23, 2026](https://developers.google.com/youtube/v3/revision_history#june-23,-2026)
- [June 3, 2026](https://developers.google.com/youtube/v3/revision_history#june-3,-2026)
- [June 1, 2026](https://developers.google.com/youtube/v3/revision_history#june-1,-2026)
- [December 4, 2025](https://developers.google.com/youtube/v3/revision_history#december-4,-2025)
- [July 10, 2025](https://developers.google.com/youtube/v3/revision_history#july-10,-2025)
- [March 26, 2025](https://developers.google.com/youtube/v3/revision_history#march-26,-2025)
- [October 30, 2024](https://developers.google.com/youtube/v3/revision_history#october-30,-2024)
- [April 30, 2024](https://developers.google.com/youtube/v3/revision_history#april-30,-2024)
- [March 13, 2024](https://developers.google.com/youtube/v3/revision_history#march-13,-2024)
- [March 12, 2024](https://developers.google.com/youtube/v3/revision_history#march-12,-2024)
- [March 7, 2024](https://developers.google.com/youtube/v3/revision_history#march-7,-2024)
- [January 31, 2024](https://developers.google.com/youtube/v3/revision_history#january-31,-2024)
- [November 09, 2023](https://developers.google.com/youtube/v3/revision_history#november-09,-2023)
- [September 12, 2023](https://developers.google.com/youtube/v3/revision_history#september-12,-2023)
- [August 22, 2023](https://developers.google.com/youtube/v3/revision_history#august-22,-2023)
- [August 18, 2023](https://developers.google.com/youtube/v3/revision_history#august-18,-2023)
- [August 7, 2023](https://developers.google.com/youtube/v3/revision_history#august-7,-2023)
- [June 28, 2023](https://developers.google.com/youtube/v3/revision_history#june-28,-2023)
- [June 12, 2023](https://developers.google.com/youtube/v3/revision_history#june-12,-2023)
- [August 22, 2022](https://developers.google.com/youtube/v3/revision_history#august-22,-2022)
- [August 5, 2022](https://developers.google.com/youtube/v3/revision_history#august-5,-2022)
- [July 12, 2022](https://developers.google.com/youtube/v3/revision_history#july-12,-2022)
- [April 27, 2022](https://developers.google.com/youtube/v3/revision_history#april-27,-2022)
- [April 8, 2022](https://developers.google.com/youtube/v3/revision_history#april-8,-2022)
- [December 15, 2021](https://developers.google.com/youtube/v3/revision_history#december-15,-2021)
- [November 18, 2021](https://developers.google.com/youtube/v3/revision_history#november-18,-2021)
- [July 2, 2021](https://developers.google.com/youtube/v3/revision_history#july-2,-2021)
- [July 1, 2021](https://developers.google.com/youtube/v3/revision_history#july-1,-2021)
- [May 12, 2021](https://developers.google.com/youtube/v3/revision_history#may-12,-2021)
- [February 9, 2021](https://developers.google.com/youtube/v3/revision_history#february-9,-2021)
- [January 28, 2021](https://developers.google.com/youtube/v3/revision_history#january-28,-2021)
- [October 15, 2020](https://developers.google.com/youtube/v3/revision_history#october-15,-2020)
- [October 8, 2020](https://developers.google.com/youtube/v3/revision_history#october-8,-2020)
- [September 9, 2020](https://developers.google.com/youtube/v3/revision_history#september-9,-2020)
- [July 29, 2020](https://developers.google.com/youtube/v3/revision_history#july-29,-2020)
- [July 28, 2020](https://developers.google.com/youtube/v3/revision_history#july-28,-2020)
- [July 21, 2020](https://developers.google.com/youtube/v3/revision_history#july-21,-2020)
- [July 7, 2020](https://developers.google.com/youtube/v3/revision_history#july-7,-2020)
- [June 15, 2020](https://developers.google.com/youtube/v3/revision_history#june-15,-2020)
- [June 4, 2020](https://developers.google.com/youtube/v3/revision_history#june-4,-2020)
- [April 17, 2020](https://developers.google.com/youtube/v3/revision_history#april-17,-2020)
- [March 31, 2020](https://developers.google.com/youtube/v3/revision_history#march-31,-2020)
- [January 10, 2020](https://developers.google.com/youtube/v3/revision_history#january-10,-2020)
- [September 10, 2019](https://developers.google.com/youtube/v3/revision_history#september-10,-2019)
- [April 4, 2019](https://developers.google.com/youtube/v3/revision_history#april-4,-2019)
- [July 9, 2018](https://developers.google.com/youtube/v3/revision_history#july-9,-2018)
- [June 22, 2018](https://developers.google.com/youtube/v3/revision_history#june-22,-2018)
- [November 27, 2017](https://developers.google.com/youtube/v3/revision_history#november-27,-2017)
- [November 16, 2017](https://developers.google.com/youtube/v3/revision_history#november-16,-2017)
- [October 25, 2017](https://developers.google.com/youtube/v3/revision_history#october-25,-2017)
- [August 29, 2017](https://developers.google.com/youtube/v3/revision_history#august-29,-2017)
- [July 24, 2017](https://developers.google.com/youtube/v3/revision_history#july-24,-2017)
- [June 1, 2017](https://developers.google.com/youtube/v3/revision_history#june-1,-2017)
- [May 17, 2017](https://developers.google.com/youtube/v3/revision_history#may-17,-2017)
- [April 27, 2017](https://developers.google.com/youtube/v3/revision_history#april-27,-2017)
- [March 30, 2017](https://developers.google.com/youtube/v3/revision_history#march-30,-2017)
- [February 27, 2017](https://developers.google.com/youtube/v3/revision_history#february-27,-2017)
- [November 29, 2016](https://developers.google.com/youtube/v3/revision_history#november-29,-2016)
- [November 10, 2016](https://developers.google.com/youtube/v3/revision_history#november-10,-2016)
- [November 2, 2016](https://developers.google.com/youtube/v3/revision_history#november-2,-2016)
- [September 15, 2016](https://developers.google.com/youtube/v3/revision_history#september-15,-2016)
- [August 11, 2016](https://developers.google.com/youtube/v3/revision_history#august-11,-2016)
- [June 13, 2016](https://developers.google.com/youtube/v3/revision_history#june-13,-2016)
- [May 31, 2016](https://developers.google.com/youtube/v3/revision_history#may-31,-2016)
- [May 17, 2016](https://developers.google.com/youtube/v3/revision_history#may-17,-2016)
- [April 28, 2016](https://developers.google.com/youtube/v3/revision_history#april-28,-2016)
- [April 20, 2016](https://developers.google.com/youtube/v3/revision_history#april-20,-2016)
- [March 16, 2016](https://developers.google.com/youtube/v3/revision_history#march-16,-2016)
- [December 18, 2015](https://developers.google.com/youtube/v3/revision_history#december-18,-2015)
- [November 19, 2015](https://developers.google.com/youtube/v3/revision_history#november-19,-2015)
- [November 4, 2015](https://developers.google.com/youtube/v3/revision_history#november-4,-2015)
- [August 28, 2015](https://developers.google.com/youtube/v3/revision_history#august-28,-2015)
- [August 7, 2015](https://developers.google.com/youtube/v3/revision_history#august-7,-2015)
- [June 18, 2015](https://developers.google.com/youtube/v3/revision_history#june-18,-2015)
- [April 27, 2015](https://developers.google.com/youtube/v3/revision_history#april-27,-2015)
- [April 16, 2015](https://developers.google.com/youtube/v3/revision_history#april-16,-2015)
- [April 9, 2015](https://developers.google.com/youtube/v3/revision_history#april-9,-2015)
- [April 2, 2015](https://developers.google.com/youtube/v3/revision_history#april-2,-2015)
- [March 11, 2015](https://developers.google.com/youtube/v3/revision_history#march-11,-2015)
- [March 4, 2015](https://developers.google.com/youtube/v3/revision_history#march-4,-2015)
- [March 2, 2015](https://developers.google.com/youtube/v3/revision_history#march-2,-2015)
- [January 14, 2015](https://developers.google.com/youtube/v3/revision_history#january-14,-2015)
- [November 11, 2014](https://developers.google.com/youtube/v3/revision_history#november-11,-2014)
- [October 8, 2014](https://developers.google.com/youtube/v3/revision_history#october-8,-2014)
- [September 12, 2014](https://developers.google.com/youtube/v3/revision_history#september-12,-2014)
- [August 13, 2014](https://developers.google.com/youtube/v3/revision_history#august-13,-2014)
- [August 12, 2014](https://developers.google.com/youtube/v3/revision_history#august-12,-2014)
- [July 8, 2014](https://developers.google.com/youtube/v3/revision_history#july-8,-2014)
- [June 18, 2014](https://developers.google.com/youtube/v3/revision_history#june-18,-2014)
- [May 28, 2014](https://developers.google.com/youtube/v3/revision_history#may-28,-2014)
- [May 13, 2014](https://developers.google.com/youtube/v3/revision_history#may-13,-2014)
- [May 2, 2014](https://developers.google.com/youtube/v3/revision_history#may-2,-2014)
- [April 7, 2014](https://developers.google.com/youtube/v3/revision_history#april-7,-2014)
- [March 31, 2014](https://developers.google.com/youtube/v3/revision_history#march-31,-2014)
- [March 13, 2014](https://developers.google.com/youtube/v3/revision_history#march-13,-2014)
- [March 4, 2014](https://developers.google.com/youtube/v3/revision_history#march-4,-2014)
- [December 5, 2013](https://developers.google.com/youtube/v3/revision_history#december-5,-2013)
- [October 24, 2013](https://developers.google.com/youtube/v3/revision_history#october-24,-2013)
- [October 1, 2013](https://developers.google.com/youtube/v3/revision_history#october-1,-2013)
- [August 27, 2013](https://developers.google.com/youtube/v3/revision_history#august-27,-2013)
- [August 15, 2013](https://developers.google.com/youtube/v3/revision_history#august-15,-2013)
- [August 8, 2013](https://developers.google.com/youtube/v3/revision_history#august-8,-2013)
- [July 30, 2013](https://developers.google.com/youtube/v3/revision_history#july-30,-2013)
- [June 10, 2013](https://developers.google.com/youtube/v3/revision_history#june-10,-2013)
- [May 22, 2013](https://developers.google.com/youtube/v3/revision_history#may-22,-2013)
- [May 14, 2013](https://developers.google.com/youtube/v3/revision_history#may-14,-2013)
- [May 10, 2013](https://developers.google.com/youtube/v3/revision_history#may-10,-2013)
- [May 8, 2013](https://developers.google.com/youtube/v3/revision_history#may-8,-2013)
- [May 2, 2013](https://developers.google.com/youtube/v3/revision_history#may-2,-2013)
- [April 19, 2013](https://developers.google.com/youtube/v3/revision_history#april-19,-2013)
- [March 12, 2013](https://developers.google.com/youtube/v3/revision_history#march-12,-2013)
- [February 25, 2013](https://developers.google.com/youtube/v3/revision_history#february-25,-2013)
- [January 30, 2013](https://developers.google.com/youtube/v3/revision_history#january-30,-2013)
- [January 16, 2013](https://developers.google.com/youtube/v3/revision_history#january-16,-2013)
...
# Revision History    Stay organized with collections      Save and categorize content based on your preferences.
...
- The YouTube Data API v3 has added support for identifying videos with altered or synthetic content through the `status.containsSyntheticMedia` property as of October 30, 2024.

- As of April 30, 2024, channel discussions are no longer supported within the YouTube Data API.

- Effective April 12, 2024, the `sync` parameter for captions is unsupported, necessitating timing information for all caption uploads.

- Recent updates have deprecated several API features, including `brandingSettings.channel.moderateComments`, `comments.markAsSpam`, `commentThreads.update`, and the `search.list` method's `relatedToVideoId`.
...
This page lists YouTube Data API (v3) changes and documentation updates. [Subscribe to this changelog](https://developers.google.com/youtube/v3/feeds/data-api-revision-history.xml?utm_source=docs&utm_medium=revision_history_page&utm_campaign=rss_subscribe). [![Subscribe](https://developers.google.com/static/analytics/images/rss-o16.png)](https://developers.google.com/youtube/v3/feeds/data-api-revision-history.xml?utm_source=docs&utm_medium=revision_history_page&utm_campaign=rss_subscribe)

### September 1, 2026

The `videos.getRating` method now accepts the `https://www.googleapis.com/auth/youtube.readonly` authorization scope.

### August 27, 2026

YouTube will align public view counting for all video formats: long-form videos, Live, and Shorts. YouTube will count public views the moment a video begins to play.

Monetization eligibility and the majority of core performance metrics are unaffected as they remain anchored on engaged metrics. Creator earnings will continue to be based on "Engaged Shorts views" and "Engaged Watch Hours," which you can view in **YouTube Analytics** \> **Advanced Mode**.

There is no change to YouTube Partner Program eligibility. YouTube Partner Program entry requirements will also now be referred to as "qualified Shorts views" and "qualified watch hours" (previously "valid public Shorts views" and "valid public watch hours").

To learn more, see [Understand your YouTube content performance](https://support.google.com/youtube/answer/12220281).

| Metric | Status | Trigger | Used For |
| --- | --- | --- | --- |
| **View** | Updated | Video plays from the **first frame** (includes autoplay, hold the pointer over, and click/tap to play). | Standard public view counts. |
| **Engaged View** | Unchanged | Playback continues past the first frame, or the user clicks/taps to play. | Monetization through YouTube Partner Program, majority of core analytics (click-through rate, average view duration), and engaged reporting. |
| **Thumbnail Impression** | Unchanged | Thumbnail is displayed without interaction or autoplay. | Measures feed-level exposure and packaging. |

**API documentation updates:** Updated the description of the `viewCount` field in the [channels](https://developers.google.com/youtube/v3/docs/channels) and [videos](https://developers.google.com/youtube/v3/docs/videos) reference documentation.

### August 6, 2026

This update contains the following changes:

- All references to `contentDetails.like`, `contentDetails.favorite`, and `contentDetails.subscription` fields under [`activities.contentDetails`](https://developers.google.com/youtube/v3/docs/activities#contentDetails) have been removed from public documentation as these fields are not returned by the API.

### July 7, 2026

This update contains the following changes:

The API now supports the `brandPartner` part in the `videos` resource. This part contains details about the brand partner linked to the video for [creator-initiated brand partner access](https://support.google.com/youtube/answer/15672082).

The `brandPartner` part can be specified when calling the following methods:

- `videos.insert`
- `videos.update`
- `videos.list`

The `brandPartner` object contains the following fields:

- `channelId`: The external channel ID of the brand partner.
- `channelHandle`: The channel handle of the brand partner.

Either `channelId` or `channelHandle` must be set when establishing a link, but only `channelId` is returned in the response.

### June 23, 2026

This update contains the following changes:

- All references to the `messageDeletedEvent` and `messageRetractedEvent` resource types (and their corresponding `messageDeletedDetails` and `messageRetractedDetails` objects) under [`liveChatMessages`](https://developers.google.com/youtube/v3/live/docs/liveChatMessages) have been removed as these events are not being returned by the API.

### June 3, 2026

This update contains the following changes:

The API now supports a new method, `videos.batchGetStats`, which retrieves a list of video statistics that match the API request parameters.

A call to this method has a [quota cost](https://developers.google.com/youtube/v3/getting-started#quota) of 1 unit in its own granular quota bucket. The method's default quota is 10,000 units per day.
...
API calls to the `videos.insert` and `search.list` methods will be charged to their own respective quota buckets. API calls to all other methods will be charged to the existing quota bucket. Developers can view quota limits in the [Google Cloud Console](https://console.cloud.google.com/), and they can request additional quota through the [Quota Extension Form](https://support.google.com/youtube/contact/yt_api_form).

### December 4, 2025

The YouTube Data API documentation and [Quota Calculator](https://developers.google.com/youtube/v3/determine_quota_cost) have been updated to reflect a change in the quota cost of a video upload from approximately 1600 units to approximately 100 units.
...
method
and, if your code requires a `commentThreads` resource, make a secondary call to the
...
- The following `channel` resource
...
- The following `channelSection` resource
properties have been deprecated. These properties are already unsupported in the YouTube Studio UI
and on YouTube. As a result, they are also no longer supported via the API.
...
- The `snippet.videoOwnerChannelId`
property identifies the ID of the channel that uploaded the playlist video.
- The `snippet.videoOwnerChannelTitle`
...
- The `playlistItems.delete`,
`playlistItems.insert`,
`playlistItems.list`,
`playlistItems.update`,
`playlists.delete`,
`playlists.list`, and
`playlists.update` methods all support
...
- The `playlistItems.list` method's
...
- The new [Section III.E.4.i](https://developers.google.com/youtube/terms/developer-policies#III-E-4-i) provides
...
- The new [Section III.E.4.j](https://developers.google.com/youtube/terms/developer-policies#III-E-4-j) relates
...
if they contained unescaped quotation marks (`"`). Note that the 500 character
...
immediately and will stop working on or after the date of this announcement:
  ...
  - The `channels.list` method's
     `categoryId` filter parameter
  - The `guideCategories` resource
     and the `guideCategories.list`
     method
- API responses for the
`channels.list` method no
longer contain the
`prevPageToken`
property if the API request sets the
`managedByMe` parameter
to `true`. This change does not affect the `prevPageToken` property
for other `channels.list` requests, and it does not affect the
`nextPageToken`
property for any requests.

- The `channel` resource's `contentDetails.relatedPlaylists.watchLater`
and `contentDetails.relatedPlaylists.watchHistory` properties were both announced
as deprecated on [11 August 2016](https://developers.google.com/youtube/v3/revision_history#august-11,-2016). The
`playlistItems.insert` method's and `playlistItems.delete` method's support
for these playlists are also now fully deprecated, and the two properties have been removed
from the documentation.
- The `channels.list` method's `mySubscribers` parameter, which was
announced as deprecated on [30 July 2013](https://developers.google.com/youtube/v3/revision_history#release_notes_07_30_2013), has been
removed from the documentation. Use the
`subscriptions.list` method and
its `mySubscribers` parameter to retrieve a list of subscribers to the
authenticated user's channel.

- The `channel` resource's `invideoPromotion` object and all of its child
properties, which were announced as deprecated on
[27 November 2017](https://developers.google.com/youtube/v3/revision_history#november-27,-2017), have been removed from the documentation.
...
- **New resources and methods**
  - The new `member` resource represents a
    ...
    This resource replaces the `sponsor`
...
- The `selfDeclaredMadeForKids` property enables content creators to specify whether a
[channel](https://developers.google.com/youtube/v3/docs/channels#status.selfDeclaredMadeForKids) or
[video](https://developers.google.com/youtube/v3/docs/videos#status.selfDeclaredMadeForKids) is made for kids.
...
`channels.update` method. For videos,
this property can be set when calling either the
`videos.insert` or
`videos.update` methods.





Note that this property is only included in API responses that contain `channel` or
`video` resources if the channel owner authorized the API request.

- The `madeForKids` property enables any user to retrieve the "made for kids" status
of a [channel](https://developers.google.com/youtube/v3/docs/channels#status.madeForKids) or
[video](https://developers.google.com/youtube/v3/docs/videos#status.madeForKids). For example, the status might be
determined based on the value of the `selfDeclaredMadeForKids` property. See the
[YouTube Help Center](https://support.google.com/youtube/answer/9527654) for more
...
- The [interactive code snippet tool](https://developers.google.com/youtube/v3/code_samples/code_snippets) now supports Node.js code samples. The samples are also visible in the documentation for almost all API methods, such as the `channels.list` method.
...
1. Go to the [interactive code snippet tool](https://developers.google.com/youtube/v3/code_samples/code_snippets) or to the documentation for any API method, such as the `channels.list` method.
...
As originally [announced on August 11, 2016](https://developers.google.com/youtube/v3/revision_history#topic-id-changes), YouTube has switched the supported list of topic IDs to a curated list. The complete list of supported topic IDs is included in the `topicDetails` properties for `channel` and `video` resources as well as in the `search.list` method's `topicId` parameter.
...
So that you can prepare your API Clients for those changes, the definitions of the following API parameters and properties have been updated to list the topic IDs that will be supported after that time. Note that the list of categories is the same for all of the properties.
  - The `channel` resource's `topicDetails.topicIds[]` property.
  - The `video` resource's `topicDetails.relevantTopicIds[]` property.
  - The `search.list` method's `topicId` parameter.
- **Note:** This is a deprecation announcement.
...
- **Updates to existing methods, properties and parameters**
  - The `channelSection` resource description has been updated to note that a channel can create a maximum of 10 shelves without setting [targeting data](https://developers.google.com/youtube/v3/docs/channelSections#targeting) and can create a maximum of 100 shelves with targeting data.
  ...
  - The `search.list` method's `publishedBefore` and `publishedAfter` parameters have both been updated to indicate that the parameter values are inclusive. So, for example, if the `publishedBefore` parameter is set, the API returns resources created before _or at_ the specified time.
...
- **Updates to existing resources and methods**
  ...
  - The `channel` resource's new `snippet.customUrl` property identifies the custom URL associated with the channel. (Not all channels have custom URLs.) The [YouTube Help Center](https://support.google.com/youtube/answer/2657968) explains eligibility requirements for getting a custom URL as well as how to set up the URL.
...
- **New and updated errors**
  - The API now supports the following errors:
    ...
    | Description | The `kind` property does not match the type of ID provided. | |
    | `commentThreads.update`<br>`comments.insert`<br>`comments.update` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `commentTextTooLong` |
    | Description | The `comment` resource that is being inserted or updated contains too many characters in the `snippet.topLevelComment.snippet.textOriginal` property. | |
    | `playlistItems.insert`<br>`playlistItems.update` | |     |     |
    | --- | --- |
    | HTTP Response Code | `forbidden (403)` |
    | Reason | `playlistItemsNotAccessible` |
    | Description | The request is not properly authorized to insert, update, or delete the specified playlist item. | |
    | `playlists.delete`<br>`playlists.insert`<br>`playlists.update` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `playlistForbidden` |
    | Description | This operation is forbidden or the request is not properly authorized. | |
    | `search.list` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `invalidLocation` |
    | Description | The `location` and/or `locationRadius` parameter value was formatted incorrectly. | |
    | `search.list` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `invalidRelevanceLanguage` |
    | Description | The `relevanceLanguage` parameter value was formatted incorrectly. | |
    | `subscriptions.insert` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `subscriptionForbidden` |
    | Description | This error occurs when any of the following are true:<br> <br>    - The subscription that you are trying to create already exists<br>    - You have already reached your maximum number of subscriptions<br>    - You are trying to subscribe to your own channel, which is not supported.<br>    - You have created too many subscriptions recently and need to wait a few hours before retrying the request. | |
    | `videos.update` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `invalidDefaultBroadcastPrivacySetting` |
    | Description | The request attempts to set an invalid privacy setting for the default broadcast. | |
...
- **New and updated errors**
  - The API now supports the following errors:
    ...
    | Description | The user must verify her email address prior to rating the video. | |
    | `videos.rate` | |     |     |
    | --- | --- |
    | HTTP Response Code | `badRequest (400)` |
    | Reason | `videoPurchaseRequired` |
    | Description | Rental videos can only be rated by users who rented them. | |
...
- **Updates to existing resources and methods**
  ...
  - The API now supports targeting for `channelSection` resources. Channel section targeting provides a way to restrict visibility of a content section to users that match particular criteria.
    ...
    - `targeting.languages[]`: A list of [YouTube application languages](https://developers.google.com/youtube/v3/docs/i18nLanguages). Users who have chosen one of those languages can see the corresponding channel section.

    - `targeting.regions[]`: A list of [YouTube preferred content regions](https://developers.google.com/youtube/v3/docs/i18nRegions). The channel section is visible to users that have selected one of those regions as well as users for whom one of those regions is automatically selected.

    - `targeting.countries[]`: A list of countries where the channel section is visible. Each value in the list is an [ISO 3166-1 alpha-2 country code](http://www.iso.org/iso/country_codes/iso_3166_code_lists/country_names_and_code_elements.htm).
...
Note that the API's new `https://www.googleapis.com/auth/youtube.force-ssl` scope, described in the [revision history for April 2, 2015](https://developers.google.com/youtube/v3/revision_history#release_notes_04_02_2015), is required for calls to the `comments.insert`, `comments.update`, `comments.markAsSpam`, `comments.setModerationStatus`, `comments.delete`, `commentThreads.insert`, and `commentThreads.update` methods.
...
- The [YouTube Data API (v3) migration guide](https://developers.google.com/youtube/v3/migration-guide) has been updated to note that the following v2 API features will not be supported in the v3 API:
  ...
  - [Retrieve video recommendations](https://developers.google.com/youtube/2.0/developers_guide_protocol_recommendations) – The v3 API does not retrieve a list that only contains videos recommended for the current API user. However, you can use the v3 API to find recommended videos by calling the `activities.list` method and setting the `home` parameter value to `true`.
...
Note, however, that a new item added to the "Watch later" playlist is added as the last item in that list, so that list is effectively sorted from oldest to newest item.
  ...
  - [Batch processing](https://developers.google.com/youtube/2.0/developers_guide_protocol_batch_processing) – The v3 API supports one of the batch processing use cases that the v2 API had supported. The v3 API's `channels.list`, `channelSections.list`, `guideCategories.list`, `playlistItems.list`, `playlists.list`, `subscriptions.list`, `videoCategories.list`, and `videos.list` methods all support an `id` parameter, which can be used to specify a comma-delimited list of IDs (video IDs, channel IDs, etc.). Using those methods, you can retrieve a list of multiple resources with a single request.
...
- The documentation for the `videos.insert` method has been updated to include the new JavaScript code sample described above. The list of [JavaScript code samples](https://developers.google.com/youtube/v3/code_samples/javascript#upload_video) for the YouTube Data API (v3) has also been updated.
...
| Error type | Error detail | Description |
| --- | --- | --- |
| `badRequest` | `bannerAlbumFull` | The channel owner's YouTube Channel Art album has too many images. The channel owner should go to [http://photos.google.com](http://photos.google.com/), navigate to the albums page, and remove some from images from that album. |
...
- The quota cost for a call to the `search.list` method has changed from 1 unit to 2 units in addition to the cost of the specified [resource parts](https://developers.google.com/youtube/v3/docs/search/list#part).
...
The API supports a method to [list](https://developers.google.com/youtube/v3/docs/i18nLanguages/list) supported application languages. Supported languages can be used as the value of the `hl` parameter when calling API methods like `videoCategories.list` and `guideCategories.list`.
...
The API supports a method to [list](https://developers.google.com/youtube/v3/docs/i18nLanguages/list) supported content regions. Supported region codes can be used as the value of the `regionCode` parameter when calling API methods like `search.list`, `videos.list`, `activities.list`, and `videoCategories.list`.
...
The new `snippet.liveBroadcastContent` property in search results indicates whether a video or channel resource has live broadcast content. Valid property values are `upcoming`, `active`, and `none`.
  ...
  - The `video` resource's new `liveStreamingDetails` property is an object that contains metadata about a live video broadcast. To retrieve this metadata, include `liveStreamingDetails` in the `part` parameter value's list of resource parts. The metadata includes the following new properties:
    ...
    - `liveStreamingDetails.actualStartTime` – The time that the broadcast actually started. (This value will be present once the broadcast's state is `active`.)
...
- The `videos.list` method supports new parameters for retrieving a chart of the most popular videos on YouTube:
  ...
  - The `videoCategoryId` parameter identifies the [video category](https://developers.google.com/youtube/v3/docs/videoCategories) for which the chart should be retrieved. This parameter can only be used in conjunction with the `chart` parameter. By default, charts are not restricted to a particular category.
...
- The new `channelBanners.insert` method enables you to upload a banner image that can subsequently be set as the banner image for a channel using the `channel` resource's new `brandingSettings.image.bannerExternalUrl` property.

- The documentation for the `channels.update` method has been updated to list the properties that can be modified when calling the method.

- The `video` resource documentation no longer lists `unspecified` as a valid property value for the `suggestions.processingErrors[]`, `suggestions.processingHints[]`, `suggestions.processingWarnings[]`, and `suggestions.editorSuggestions[]` properties.

- The `videos.list` method's `maxResults` parameter now has a default value of `5`.

- The `error documentation` now lists errors for the `channelBanners.insert` and `subscriptions.list` methods. It also lists several new errors for the `channels.update` method.
...
The [error documentation](https://developers.google.com/youtube/v3/docs/errors#videos_youtube.videos.rate) has also been updated to list the errors that the API might return in response to a `videos.rate` method call.

- Thumbnail images are now identified in the API documentation as a [separate resource](https://developers.google.com/youtube/v3/docs/thumbnails), and the new `thumbnails.set` method enables you to upload a custom video thumbnail to YouTube and set it for a video.

The [error documentation](https://developers.google.com/youtube/v3/docs/errors) has also been updated to list the errors that the API might return in response to a `thumbnails.set` method call.
...
- The `video` resource contains the following new properties:
  - The `status.publicStatsViewable` property indicates whether extended video statistics on the watch page are publicly viewable. By default, those statistics are viewable, and statistics like a video's viewcount and ratings will still be publicly visible even if this property's value is set to `false`. You can set this property's value when calling the `videos.insert` or `videos.update` method.

  - The `contentDetails.contentRating` object encapsulates ratings that the video received under various rating schemes. The list below identifies the supported rating systems and provides a link to the property associated with each rating system. The property definitions identify the supported rating values for each system.
    ...
    | --- | --- | --- |
    | `United States` | Motion Picture Association of America (MPAA) | `contentDetails.contentRating.mpaaRating` |
...
- The [error documentation](https://developers.google.com/youtube/v3/docs/errors) describes a new `forbidden` error, which indicates that a request is not properly authorized for the requested action.
...
- An `activity` resource can now report a `channelItem` action, which occurs when YouTube adds a video to an [automatically generated YouTube channel](http://support.google.com/youtube/bin/answer.py?answer=2579942). (YouTube algorithmically identifies topics that have a significant presence on the YouTube website and automatically generates channels for those topics.)
...
| `videoCategoryId` | `string` | Filter video search results to only include videos associated with the specified [video category](https://developers.google.com/youtube/v3/docs/videoCategories). |
...
| `video` | `recordingDetails.recordingDate` | `datetime` | The date and time when the video was recorded. The value is specified in [ISO 8601](https://www.w3.org/TR/NOTE-datetime) (`YYYY-MM-DDThh:mm:ss.sZ`) format. |
...
| Method | Properties |
| --- | --- |
| `activities.insert` | **Required properties:** <br>  - `snippet.description`<br> **Modifiable properties:** <br>  - `snippet.description`<br>  - `contentDetails.bulletin.resourceId` |
| `playlists.update` | **Required properties:** <br>  - `id` |
| `playlistItems.update` | **Required properties:** <br>  - `id` |
| `videos.update` | **Required properties:** <br>  - `id` |
...
| --- | --- | --- | --- |
| `guideCategories.list` | `notFound` | `notFound` | The guide category identified by the `id` parameter cannot be found. Use the [guideCategories.list](https://developers.google.com/youtube/v3/docs/guideCategories/list) method to retrieve a list of valid values. |
...
| `videoCategories.list` | `notFound` | `videoCategoryNotFound` | The video category identified by the `id` parameter cannot be found. Use the [videoCategories.list](https://developers.google.com/youtube/v3/docs/videoCategories/list) method to retrieve a list of valid values. |
...
\[\[\["Easy to understand","easyToUnderstand","thumb-up"\],\["Solved my problem","solvedMyProblem","thumb-up"\],\["Other","otherUp","thumb-up"\]\],\[\["Missing the information I need","missingTheInformationINeed","thumb-down"\],\["Too complicated / too many steps","tooComplicatedTooManySteps","thumb-down"\],\["Out of date","outOfDate","thumb-down"\],\["Samples / code issue","samplesCodeIssue","thumb-down"\],\["Other","otherDown","thumb-down"\]\],\["Last updated 2026-09-04 UTC."\],\[\],\["The YouTube API has undergone numerous updates, including adding synthetic content identification via the \`containsSyntheticMedia\` property for videos, and introducing the \`forHandle\` parameter for retrieving channel information. Channel discussions are deprecated, as well as \`moderateComments\`, \`comments.markAsSpam\`, \`relatedToVideoId\`, and \`commentThreads.update\` functionalities. Captions now require mandatory timing, and \`videoId\` is removed from comments. The API now allows filtering videos with paid placements and offers new code samples. Additionally, many properties and resources have been deprecated, with multiple properties removed.\\n"\]\]
