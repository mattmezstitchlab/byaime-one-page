...
- Accueil : création principale ; import du dossier dans « Outils avancés » ; route et parseur d'import conservés. *(Depuis, l'accueil est un Oneboarding unique : la porte « Outils avancés » a quitté l'entrée, l'import reste accessible en lien secondaire. Voir [ONEBOARDING_PARCOURS.md](../ONEBOARDING_PARCOURS.md).)*
